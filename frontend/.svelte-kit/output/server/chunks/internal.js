...
const options = {
  ...
  templates: {
    app: ({ head, body, assets, nonce, env }) => '<!doctype html>\r\n<html lang="es">\r\n	<head>\r\n		<meta charset="utf-8" />\r\n		<link rel="icon" href="' + assets + `/favicon.png" />\r
		...
		<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&display=swap" />\r
		<script>\r
			(() => {\r
				try {\r
					const stored = localStorage.getItem('tc_theme');\r
					const theme = stored === 'dark' || stored === 'light' ? stored : 'light';\r
					document.documentElement.dataset.theme = theme;\r
					document.documentElement.style.colorScheme = theme;\r
				} catch {\r
					// noop\r
				}\r
			})();\r
